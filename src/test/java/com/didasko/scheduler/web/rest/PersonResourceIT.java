...
import com.didasko.scheduler.repository.PersonRepository;
...
public class PersonResourceIT {
    ...
    private static final Double DEFAULT_FTE = 1D;
    private static final Double UPDATED_FTE = 2D;
    ...
    public void createPerson() throws Exception {
        ...
        assertThat(testPerson.getFte()).isEqualTo(DEFAULT_FTE);
    }
    ...
    public void updatePerson() throws Exception {
        ...
        Person testPerson = personList.get(personList.size() - 1);
        assertThat(testPerson.getFte()).isEqualTo(UPDATED_FTE);
    }
