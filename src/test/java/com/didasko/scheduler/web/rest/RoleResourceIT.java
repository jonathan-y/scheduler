...
public class RoleResourceIT {
    ...
    private static final Double DEFAULT_WEIGHTING = 1D;
    private static final Double UPDATED_WEIGHTING = 2D;
    ...
    public void createRole() throws Exception {
        ...
        assertThat(testRole.getWeighting()).isEqualTo(DEFAULT_WEIGHTING);
    }
    ...
    public void getAllRoles() throws Exception {
        ...
        restRoleMockMvc.perform(get("/api/roles?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].weighting").value(hasItem(DEFAULT_WEIGHTING.doubleValue())));
    }
    ...
    public void getRole() throws Exception {
        ...
        restRoleMockMvc.perform(get("/api/roles/{id}", role.getId()))
            ...
            .andExpect(jsonPath("$.weighting").value(DEFAULT_WEIGHTING.doubleValue()));
    }
    @Test
    @Transactional
    ...
    public void updateRole() throws Exception {
        ...
        assertThat(testRole.getWeighting()).isEqualTo(UPDATED_WEIGHTING);
    }
